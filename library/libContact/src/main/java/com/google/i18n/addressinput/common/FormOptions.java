...
public final class FormOptions {
  ...
  private final Set<AddressField> hiddenFields = EnumSet.noneOf(AddressField.class);
  private final Set<AddressField> readonlyFields = EnumSet.noneOf(AddressField.class);
  private final Set<String> blacklistedRegions = new HashSet<String>();
